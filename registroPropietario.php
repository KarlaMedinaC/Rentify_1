...
<head>
    ...
    <script>
        function PropieVali() {
            var nombre, apellidoP, apellidoM, curp, telefono, direccion, email, contrasena;
            ...
            if (nombre === "" || apellidoP === "" || apellidoM === "" || curp === "" || telefono === "" || direccion === "" || email === "" || contrasena === "") {
                ...
                alert("Tienen que ser 18 caracteres tu curp");
                return false;
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Registrate para vender o rentar tu propiedad</h2>
                        <form action="./bdPropietario.php" method="post" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <label for="agree-term" class="label-agree-term"><a href="registroCliente.php" class="term-service">Quiero comprar o rentar</a></label>
                            </div>
                            <div class="form-group form-button">
                                <input type="submit" name="signup" id="signup" class="form-submit" value="Registrar" onclick="return PropieVali()">
                            </div>
                        </form>
                    ...
                    <div class="signup-image">
                        <br><br><br><br><br><br>
                        <figure><img src="logNew/images/1.png" alt="sing up image"></figure>
