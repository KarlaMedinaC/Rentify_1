...
$sql = "SELECT nombre, apellidoM, apellidoP, curp, telefono, direccion, email, contrasena FROM propietario WHERE id_propietario = '$id_propietario'";
...
<head>
	...
	<script>
		function PropieValiA() {
			...
			if (nombre === "" || apellidoP === "" || curp === "" || apellidoM === "" || telefono === "" || direccion === "" || email === "" || contrasena === "") {
...
<body class="sa">
	...
	<div class="inner">
		<form action="modificarPropietario.php" method="POST">
			<h3>Ver perfil</h3>
