...
<body>
    ...
    if(isset($_POST['enviar'])){
        ...
        $sql="INSERT INTO membresia (tipo,tiempo,costo)values('".$tipo."','".$tiempo."','".$costo."')";
...
<h1 class="p-3 mb-2 bg-dark text-white" >Agrregar Membresias</h1>
<div class="container">
<form action="<?=$_SERVER['PHP_SELF']?>" method="post"class="table table-striped">
<div class="row">
    <label for="">Tipo:</label>
    <input class="form-control" type="text" name="tipo" id=""><br>
    <label for="">Tiempo:</label>
    <input class="form-control" type="text" name="tiempo" id=""><br>
    <label for="">Costo:</label>
    <input class="form-control" type="text" name="costo" id=""><br>
    <input type="submit" name="enviar" value="Agregar" class='btn btn-primary rounded-pill px-3'>
    <br>
