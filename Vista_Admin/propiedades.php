...
<body>
    ...
    <section id="propiedades" class="propiedades">
        <h1 class="p-3 mb-2 bg-dark text-white">Propiedades Aprobadas</h1>
        

        <div class="border p-5">
        <div class="form-group">
            <a href="propiedadesPendi.php" class="btn btn-primary">Propiedades pendientes</a>
        </div>
                        ...
                        if ($verFilasPropiedades < 1) {
                            ...
                            while ($filaPropiedad = mysqli_fetch_array($ejecutarConsultaPropiedades)) {
                                echo '<tr>
                                    ...
                                    <td>' . $filaPropiedad['Recámaras'] . '</td>
                                    <td>' . $filaPropiedad['Baños'] . '</td>
                                    <td>' . $filaPropiedad['Estacionamiento'] . '</td>
                                    <td>' . $filaPropiedad['M2 Construcción'] . '</td>
                                    <td>' . $filaPropiedad['M2 Terreno'] . '</td>
