            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        <h2 class="form-title">Iniciar Sesión Como Socio</h2>
                        <form method="post" action="./bdloginProp.php" class="register-form" id="login-form">
                            ...
                            <a href="registroPropietario.php" class="signup-image-link">Registrarme como socio</a>
                        </form>
