...
if (isset($_POST["buscarr"])) {
    ...
    if ($buscarr == "quienes somos"|| $buscarr == "Quienes somos" || $buscarr == "Quienessomos" || $buscarr == "quienessomos") {
        header("location:aboutLog.php#about");
    }else if ($buscarr == "contacto" || $buscarr == "Contacto" || $buscarr == "contactar") {
        header("location:contactoLog.php#contactos");
        ...
        header("location:rentaDepaLog.php#room");
        ...
        header("location:ventaCasaLog.php#rooms");
    }else if ($buscarr == "Como funciona" ||$buscarr == "¿Como funciona?" ||$buscarr == "¿como funciona?" ||$buscarr == "como funciona") {
        header("location:indexLog.php#faqa");
    }else {
        header("location:indexLog.php#cta");
    }
}
?>
<?php 
            ...
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row gy-4">
                        ...
                        <div class="accordion accordion-flush px-xl-5" id="faqlist">
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                    <div class="accordion-body">
                                        Lamudi puede ayudarte con la búsqueda de cualquier inmueble en venta o en renta.
                    ...
                    <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img"
                        style='background-image: url("cuadroIndex/assets/img/services-2.jpg");'>&nbsp;</div>
                </div>
